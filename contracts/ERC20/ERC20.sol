...
contract ERC20 is IERC20{
    ...
    function transferFrom(
        ...
        _spenAllowance(from, spender, amount);
    ...
    function decreaseAlloeance(address spender, uint256 subtractValue) public virtual returns(bool){
        address owner = msg.sender;
        uint256 currentAllowance = _allowances[owner][spender];
        require(currentAllowance >= subtractValue, "ERC20: decreased allowance below zero");
        unchecked{
           _approve(owner, spender, currentAllowance - subtractValue);
        }
        return true;
    }
    ...
    function _spenAllowance(address owner, address spender, uint256 amount) internal virtual {
